...
description: Navigation is essential, like working with the mouse as a standard Windows user.
summary: Navigation is essential, like working with the mouse as a standard Windows user.
series: ["HTB"]
